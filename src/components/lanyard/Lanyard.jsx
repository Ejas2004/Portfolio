...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
    ...
    const cardScale = isSmall ? 9 : 7.123;
    const groupY = isSmall ? 8 : 6;
    const attachmentY = isSmall ? 8.5 :7.3;
    ...
    return (
        <>
            <group position={[0, groupY, 0]}>
                ...
                <RigidBody position={[0.75, 0, 0]} ref={j1} {...segmentProps}>
                    <BallCollider args={[0.1]} />
                </RigidBody>
                <RigidBody position={[1.5, 0, 0]} ref={j2} {...segmentProps}>
                    <BallCollider args={[0.1]} />
                </RigidBody>
                <RigidBody position={[2.25, 0, 0]} ref={j3} {...segmentProps}>
                    <BallCollider args={[0.1]} />
                </RigidBody>
                <RigidBody position={[3.0, 0, 0]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
